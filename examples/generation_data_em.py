...
pump_energy_array = np.linspace(1000,5000,10)*fJ
    ...
    for pp_mismatch in pp_mismatch_array:
        for E2 in pump_energy_array:
            ...
            if i % 250 == 0:
                ...
                df.to_csv(f"/raid/robert/SHG_output_final_more_{i}.csv", index=False)
...
csv_file_path = "/raid/robert/SHG_output_final_more1.csv"

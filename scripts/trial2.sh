...
CUDA_VISIBLE_DEVICES=0 python train_darcy.py --incremental.incremental_grad=True #--incremental.incremental_res=True
python train_darcy.py --incremental.incremental_res=True

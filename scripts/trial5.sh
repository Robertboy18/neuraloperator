...
for s in 0;
do
    CUDA_VISIBLE_DEVICES=0 python train_navier_stokes-high.py --seed=1 --mode=90 & CUDA_VISIBLE_DEVICES=1 python train_navier_stokes-high.py --mode=60 --seed=1 & CUDA_VISIBLE_DEVICES=2 python train_navier_stokes-high.py --mode=30 --seed=1 & CUDA_VISIBLE_DEVICES=3 python train_navier_stokes-high.py --mode=90 --seed=0
done

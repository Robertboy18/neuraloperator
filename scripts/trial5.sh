...
for s in 2;
do
    CUDA_VISIBLE_DEVICES=0 python train_navier_stokes-high.py --seed=$s & CUDA_VISIBLE_DEVICES=1 python train_navier_stokes-high.py --mode=60 --seed=$s & CUDA_VISIBLE_DEVICES=2 python train_navier_stokes-high.py --mode=30 --seed=$s & CUDA_VISIBLE_DEVICES=3 python train_navier_stokes-high.py --mode=10 --seed=$s
done

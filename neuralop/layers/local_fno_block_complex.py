...
from .differential_conv import FiniteDifferenceConvolution_v2
...
class LocalFNOBlocksComplex(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.differential = nn.ModuleList(
            [
                ComplexValued(FiniteDifferenceConvolution_v2(self.in_channels, self.out_channels,
                                            self.n_dim, self. grid_width, self.fin_diff_kernel_size, 
        ...
        self.local_convs = nn.ModuleList(
            [
                ComplexValued(DISCOConv1d(in_channels= self.in_channels,
    ...
    def forward_with_postactivation(self, x, index=0, output_shape=None):
        ...
        if self.differential_idx_list[index] != -1:
            x_differential = self.differential[self.differential_idx_list[index]](x)

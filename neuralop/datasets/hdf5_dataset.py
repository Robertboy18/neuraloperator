...
class H5pyDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x = self.data['512x512x2_wn1.0']['fields'][idx, 1:, ::self.subsample_step, ::self.subsample_step]
        y = self.data['512x512x2_wn1.0']['fields'][idx+1, 1:, ::self.subsample_step, ::self.subsample_step]
